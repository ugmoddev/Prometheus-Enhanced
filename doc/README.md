...
Use the [Prometheus Enhanced Playground](https://ugmoddev.github.io/Prometheus-Enhanced/) to quickly try out settings and test small snippets. For larger scripts and advanced workflows, use the CLI (`prometheus-lua` or `cli.lua`).
